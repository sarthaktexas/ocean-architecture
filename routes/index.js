  ...
  switch (event.type) {
    case 'payment_intent.succeeded':
      ...
      const successembed = new Discord.MessageEmbed()
        ...
        .setColor('#0099ff')
        .setDescription(paymentIntent.charges.data.name + ' (' + paymentIntent.charges.data.email + ') has signed up and paid.');
    ...
    case 'invoice.payment_failed':
      ...
      const failembed = new Discord.MessageEmbed()
        ...
        .setColor('#DE1738')
        .setDescription(paymentFail.charges.data.customer + ' (' + paymentFail.charges.data.email + ') has not paid for the month. Delete thier account in the Auth0 Dashboard.');
